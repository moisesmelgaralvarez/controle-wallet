-- ============================================================
-- Reverso de 20260818120000_importar_todo_o_nada
--
-- Devuelve `importar_lote` a la firma de trece parámetros, sin
-- `p_rubros` ni `p_comercios`. Volver acá reabre el defecto que la
-- migración cerró: los rubros y los comercios vuelven a escribirse en
-- dos peticiones sueltas antes de la transacción, y un fallo entre
-- medio deja rubros creados que nadie usa.
-- ============================================================
