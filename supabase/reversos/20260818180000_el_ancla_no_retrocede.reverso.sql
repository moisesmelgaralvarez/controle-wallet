-- ============================================================
-- Reverso de 20260818180000_el_ancla_no_retrocede
--
-- Devuelve el UPDATE directo del saldo declarado y quita la guardia de
-- fecha. Volver acá reabre el defecto: importar un estado de cuenta
-- viejo vuelve a pisar el saldo de hoy, en silencio, y la app pasa a
-- creer que la tarjeta no debe nada.
-- ============================================================

drop function if exists public.anclar_saldo_banco(text, uuid, numeric, date);
